...
from xcep.generateNet import generate_net
...
save_dir = os.path.join(save_dir_root, 'checkpoints')
...
pretrained_dict = torch.load('./deeplabv3plus_xception_VOC2012_epoch60_all.pth')
# print(pretrained_dict.keys())
pretrained_dict_copy = pretrained_dict.copy()
# print(pretrained_dict['module.backbone.conv1.weight'].shape)
...
# print(net_dict['module.backbone.conv1.weight'].shape)
