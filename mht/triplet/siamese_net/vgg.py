...
def vgg11(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_urls['vgg11']))
    return model
...
def vgg11_bn(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_urls['vgg11_bn']))
    return model
...
def vgg13(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_urls['vgg13']))
    return model
...
def vgg13_bn(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_urls['vgg13_bn']))
    return model
...
def vgg19_bn(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(model_urls['vgg19_bn']))
    return model
