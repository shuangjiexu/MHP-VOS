...
if resume_epoch != nEpochs:
    ...
    for seq_name in seq_name_list:
        ...
        for obj_id in range(2):
            ...
            for epoch in range(resume_epoch, nEpochs):
                ...
                for ii, sample_batched in enumerate(trainloader):
                    ...
                    if aveGrad % p['nAveGrad'] == 0:
                        ...
                        aveGrad = 0
                if epoch%10==9:
                    torch.save(net.state_dict(), '../checkpoints/'+seq_name+'_'+str(obj_id)+'_'+str(epoch)+'.pth')
                    print("Save model at {}\n".format('../checkpoints/'+seq_name+'_'+str(obj_id)+'_'+str(epoch)+'.pth'))  
            ...
            #         save_path = os.path.join('../all_test_file/mask_result',seq_name,str(obj_id),str(ii+1).zfill(5)+'.png')
            #         # print(mask)
