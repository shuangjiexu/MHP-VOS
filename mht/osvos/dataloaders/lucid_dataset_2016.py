...
class OnlineDataset(Dataset):
    ...
    def __init__(self, train=True,
                 inputRes=None,
                 db_root_dir='../flow_mask',
                 flow_root_dir='/media/ubuntu/ouyang11/VOS/lucid_flow',
    ...
    def make_img_gt_pair(self, idx):
        ...
        img_dir = os.path.join('../lucid_dataset', self.seq_name)
...
if __name__ == '__main__':
    ...
    dataset = OnlineDataset(db_root_dir='../flow_mask',train=True, transform=tr.ToTensor())
