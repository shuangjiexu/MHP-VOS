...
from dataloaders import lucid_dataset_segtrack as db
...
#seq_name_list = ['aerobatics', 'car-race',
#                 #'carousel', 'cats-car', 'chamaleon', 'deer', 'giant-slalom',
...
seq_name_list = sorted(os.listdir('../data/DAVIS/JPEGImages/480p'))
# obj_id = 1
...
if resume_epoch != nEpochs:
    ...
    for seq_name in seq_name_list:
        ...
        obj_num = get_obj_num('../data/DAVIS/Annotations/480p/'+seq_name+'/00000.png')
        ...
        for obj_id in range(obj_num):
            ...
            # if seq_name == 'subway' and obj_id!=4:
            #     continue
