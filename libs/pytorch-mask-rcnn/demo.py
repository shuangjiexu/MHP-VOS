...
# while True:
#     if file_namelist[0] != 'tennis-vest':
#         file_namelist.pop(0)
#     else:
#         break
for TARGET_CLASS in file_namelist:
    ...
    MODEL_PATH = os.path.join(ROOT_DIR, './checkpoints/'+TARGET_CLASS+'.pth')
    ...
    dir_results = os.path.join(ROOT_DIR, 'out/results/', TARGET_CLASS)
    if not os.path.isdir(dir_results):
        os.makedirs(dir_results)
    
    if not os.path.exists('./out/oneobject_json'):
        os.mkdir('./out/oneobject_json')
