...
class Xception(nn.Module):
    ...
    def __init__(self, os):
        ...
        self.block16=Block(728,728,1,atrous=[1*rate,2*rate,1*rate])
        self.block17=Block(728,728,1,atrous=[1*rate,2*rate,1*rate])
        self.block18=Block(728,728,1,atrous=[1*rate,2*rate,1*rate])
        self.block19=Block(728,728,1,atrous=[1*rate,2*rate,1*rate])
