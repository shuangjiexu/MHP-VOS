...
#        sys.exit(1)
    ...
    reduced_array.append(hash_list["file-seed"][0] + ", " + hash_list["file-k"][0] + ", " + hash_list["file-am"][0])
    ...
    reduced_array.append(hash_list["greedy-weight"][0])
    ...
    if max_mwis >= target:
        max_mwis_string = "\\textbf{" + max_mwis_string + "}"
